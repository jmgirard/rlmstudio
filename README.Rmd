...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/jmgirard/rlmstudio/graph/badge.svg)](https://app.codecov.io/gh/jmgirard/rlmstudio)
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental)
[![CRAN status](https://www.r-pkg.org/badges/version/rlmstudio)](https://CRAN.R-project.org/package=rlmstudio)
...
The `rlmstudio` package lets you run local Large Language Models (LLMs) over many texts from R. It is built for researchers who want to score, label, or generate text at scale on their own machine, with no data sent to a third party. To do that, it provides an R interface to the [LM Studio](https://lmstudio.ai/) CLI and REST API: you can download models, manage server instances, load or unload models into memory, and generate text directly from your R console or scripts.
