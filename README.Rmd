...
The `lms` package provides an R interface to the [LM Studio](https://lmstudio.ai/) CLI and REST API. It allows you to download local Large Language Models (LLMs), manage server instances, load or unload models into memory, and generate text directly from your R console or scripts.
