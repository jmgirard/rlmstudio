...
Turn text into the vectors an embedding model produces for it.
...
- [`install_lmstudio()`](https://jmgirard.github.io/rlmstudio/reference/install_lmstudio.md)
...
- [`rlmstudio-conditions`](https://jmgirard.github.io/rlmstudio/reference/rlmstudio-conditions.md)
  [`rlmstudio_no_server`](https://jmgirard.github.io/rlmstudio/reference/rlmstudio-conditions.md)
