...
_Last hygiene pass: 2026-09-18 (M007 plan: added the M007 row and one candidate row from the M007 scope gate)_
...
| M007 | The abort contract reaches the help pages | planned | none | normal | milestones/M007-abort-contract-docs.md |
